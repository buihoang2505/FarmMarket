    ...
    <div class="container">
        <div class="row">
            <div>
                ...
                <strong>Cám ơn quý khách đã truy cập vào website Nông sản Dũng Hà</strong><br><br>
                <p>Lập chính sách cho trang web bán nông sản "Nông sản Dũng Hà" là một phần quan trọng trong việc đảm bảo tính minh bạch, 
                ...
                <p>
                    Đảm bảo rằng mọi sản phẩm được bán trên trang web Nông sản Dũng Hà đáp ứng các tiêu chuẩn chất lượng nông sản.
                    <br><br>
                </p>
                ...
                <p>
                    Thiết lập các điều khoản và điều kiện chung về việc sử dụng trang web Nông sản Dũng Hà.<br><br>
                </p>

              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="${url}/images/dautay.jpg" alt="dâu tây Đà Lạt">                    
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/hattieu.jpg" alt="hạt tiêu daklak">    <!-- section -->                  
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/tinhdausa.jpg" alt="img">                      
                      <div class="aa-prom-content">
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="${url}/images/banner_rau.jpg" alt="banner trang chủ"></a>
          </div>
          </div>
        </div>
      </div>
          ...
          <div class="aa-testimonial-area">
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="${url}/images/review.jpg" alt="avatar 1">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                  <p>Sản phẩm chất lượng, tươi ngon, sạch sẽ. Tôi đã mua hàng rất nhiều lần và luôn
                      cảm thấy hài lòng về chất lượng sản phẩm mà nhà cung cấp mang lại. </p>
                  <div class="aa-testimonial-info">
                    <p>Bui Duc Thang</p>
                    <span>Nhân viên Viettel</span>
                  </div>
                </div>
              </li>
              <!-- single slide -->
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/review1.jpg" alt="avatar 2">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                  <p> Về chất lượng của sản phẩm thì khỏi phải bàn, rau củ luôn tươi xanh nhìn rất thích.
                      Tôi sẽ mua hàng ở đây thường xuyên<p>
                  <div class="aa-testimonial-info">
                    <p>Nguyen Xuan Hoang</p>
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/review2.jpg" alt="avatar 3">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                  <p>Nhiều lần đi làm bận rộn, không có thời gian ra siêu thị nên tôi thường mua hàng online ở đây. 
                      Chất lượng sản phẩm và dịch vụ ở đây rất là tốt!</p>
                  <div class="aa-testimonial-info">
                    <p>Nguyen Hoang An</p>
                    <span>Ca sỹ</span>
                  </div>

...
public class AdminHomePage extends HttpServlet {
   ...
   // private DecimalFormat df3 = new DecimalFormat("##.##%");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        double incre1 = (countBefore != 0) ? ((count - countBefore) / (countBefore)) * 100 : 0;
        ...
        double incre2 = (totalBefore != 0) ? ((total - totalBefore) / (totalBefore)) * 100 : 0;
        ...
        double incre3 = (countProBefore != 0) ? ((countPro - countProBefore) / (countProBefore)) * 100 : 0;
